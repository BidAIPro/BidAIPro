...
export function canonicalVehicleFamily(
  ...
  const known: readonly [string, RegExp][] = [
    ...
    ["chevrolet-silverado-1500", /(?:SILVERAD[O0].*1500|(?:K|C)1500|1500.*SILVERAD[O0])/],
    ["chevrolet-silverado-2500", /(?:SILVERAD[O0].*2500|(?:K|C)2500|2500.*SILVERAD[O0])/],
    ["chevrolet-silverado-3500", /(?:SILVERAD[O0].*3500|(?:K|C)3500|3500.*SILVERAD[O0])/],
