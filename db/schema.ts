...
export const valuations = sqliteTable(
  "valuations",
  {
    ...
    rawLowCents: integer("raw_low_cents"),
    rawMedianCents: integer("raw_median_cents"),
    rawHighCents: integer("raw_high_cents"),
    comparableMedianMileage: integer("comparable_median_mileage"),
    mileageAdjustmentCents: integer("mileage_adjustment_cents"),
    conditionAdjustmentCents: integer("condition_adjustment_cents"),
    conditionAdjustmentBps: integer("condition_adjustment_bps"),
    conditionBasis: text("condition_basis"),
